  ...
  if ($('body').hasClass('basket-body')) {
    ...
    elCheckoutBtn.on('click', function () {
      if ($(this).attr('data-approve') == "yes") {
        ...
        const label = basket[index - 1].location == "worldwide" ? basket[index - 1].tariff : basket[index - 1].location == "region" ? basket[index - 1].region : basket[index - 1].location == "country" ? basket[index - 1].country : "PRO";
        ...
        elParentTarget.find('.plan-name').text(basket[index - 1].location + ' Plan')

        elPackageItem.find('.plan-name').text(basket[index - 1].location + ' Plan')
...
function updateInputsByChoice(parent) {
  // const visibleType = $(parent).children('input:not(:checked)').data('target');
  // const hiddenType = $(parent).children('input:checked').data('target');
...
function setRegionPlan(data) {
  setBasicInPlans(data);
  let continent = data.label == "OCEANIA" ? "Oceania" : data.label == "N. AMERICA" ? "North America" : data.label == "S. America" ? "South America" : data.label;
      ...
      <div class="visible-content w-100 d-flex justify-content-between">
        <div>
          <div class="d-flex align-items-center">
            ...
            <div class="skewed-box"><span class="location-name">${basket[i].label}</span></div>
          </div>
          <div class="basic-info"><span class="plan-name">${basket[i].plan} Plan</span> /  
      ...
      <div class="hidden-content mx-auto my-3">
        <div class="top2">
          ...
          <div class="included-items-wrapper js-package-included-items d-flex align-items-baseline justify-content-around mt-3">
            <div class="included-item" data-basket-item="${i + 1} "data-label="internet-data-block">
              <div class="img-wrapper">
                <img src="img/icons/icon2.png" alt="icon1">
              </div>
              <div class="item-content">
            ...
            <div class="included-item inactive" data-basket-item="${i + 1} "data-label="voice-sms-block">
              <div class="img-wrapper">
            ...
            <div class="included-item inactive" data-basket-item="${i + 1} "data-label="virtual-number-block">
              <div class="img-wrapper">
            ...
            <div class="included-item inactive" data-basket-item="${i + 1} "data-label="substitution-number-block">
              <div class="img-wrapper">
